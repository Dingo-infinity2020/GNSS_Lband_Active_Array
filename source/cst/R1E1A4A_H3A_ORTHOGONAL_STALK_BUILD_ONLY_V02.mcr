...
' H3A Orthogonal PCB Feed-Stalk / Support Assembly V0.2 — FR4 BRIDGED MORTISE — BUILD ONLY
...
Sub Main()
    ...
    StoreParameter "h3a_v02_bridge_len", 5.5
    StoreParameter "h3a_v02_bridge_width", 2.57142857143
    ...
    With Brick
        .Reset
        .Name "FR4_BRIDGE_X_N"
        .Component "H3A_RadiatorBridge"
        .Material "FR4_COST_BASELINE"
        .Xrange "-14.75", "-9.25"
        .Yrange "-1.28571428571", "1.28571428571"
        .Zrange "57.1428571428", "58.1428571428"
        .Create
    End With

    Solid.Add "Substrate:FR4_BOARD", "H3A_RadiatorBridge:FR4_BRIDGE_X_N"
    ...
    Solid.Add "Substrate:FR4_BOARD", "H3A_RadiatorBridge:FR4_BRIDGE_X_P"
    ...
    With Brick
        ...
        .Component "H3A_RadiatorBridge"
        .Material "FR4_COST_BASELINE"
        .Xrange "-1.28571428571", "1.28571428571"
        .Yrange "-14.75", "-9.25"
        .Zrange "57.1428571428", "58.1428571428"
        .Create
    End With

    Solid.Add "Substrate:FR4_BOARD", "H3A_RadiatorBridge:FR4_BRIDGE_Y_N"
    ...
    Solid.Add "Substrate:FR4_BOARD", "H3A_RadiatorBridge:FR4_BRIDGE_Y_P"
