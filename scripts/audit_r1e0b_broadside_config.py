...
p=Path("source/cst/R1E0B_PERIODIC_BROADSIDE_SOLVER_CONFIG_V01.mcr")
...
if fail:
    print("HOLD_R1E0B_STATIC_AUDIT")
    for x in fail:
        print("- "+x)
    raise SystemExit(3)

print("PASS_R1E0B_STATIC_AUDIT")
print("BOUNDARY_COMMANDS=0")
print("GEOMETRY_CHANGES=0")
print("PORT_CHANGES=0")
print("FLOQUET_PORT_CHANGES=0")
