...
macro=ROOT/"source/cst/R1E1A4A_H3A_ORTHOGONAL_STALK_BUILD_ONLY_V01.mcr"
...
if fail:
    print("HOLD_R1E1A4A_H3A_BUILD_STATIC_AUDIT")
    for x in fail: print("- "+x)
    raise SystemExit(3)
print("PASS_R1E1A4A_H3A_BUILD_STATIC_AUDIT")
