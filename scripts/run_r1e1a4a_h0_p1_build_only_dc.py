...
def audit_vba(shape_path,status_path):
    return "\n".join([
      ...
      "Dim stype As String, zref As Double, cur As Double, vol As Double",
      ...
      ' Print #f, "P" & CStr(i) & "_IMPEDANCE=" & CStr(zref)',
...
def run(repo,evidence,work,source):
    ...
    checks={
      ...
      "p1_coords_ok":all(st[k].lower() in ("true","-1") for k in ("P1_PROP_OK","P1_COORD_OK","P2_PROP_OK","P2_COORD_OK")),
