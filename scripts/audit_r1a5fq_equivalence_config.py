...
p=Path("source/cst/R1A5FQ_EQUIVALENCE_SOLVER_CONFIG_V01.mcr")
if not p.exists():
    print("HOLD_R1A5FQ_CONFIG_MISSING")
    raise SystemExit(2)
...
if fail:
    print("HOLD_R1A5FQ_STATIC_AUDIT")
    for x in fail:
        print("- "+x)
    raise SystemExit(3)

print("PASS_R1A5FQ_STATIC_AUDIT")
