...
DST=ROOT/"source/cst/R1E1A4A_H3A_ORTHOGONAL_STALK_BUILD_ONLY_V01.mcr"
...
lines=["Option Explicit","","' H3A Orthogonal PCB Feed-Stalk / Support Assembly V0.1 — BUILD ONLY",
