...
def run(repo,evidence,work,source):
    ...
    macro=os.path.join(repo,"source","cst","R1E1A4A_H3A_ORTHOGONAL_STALK_BUILD_ONLY_V01.mcr")
    if not os.path.isfile(macro): raise RuntimeError("HOLD_H3A_MACRO_MISSING")
    os.makedirs(evidence); os.makedirs(work)
    dst=os.path.join(work,"R1E1A4A_H3A_ORTHOGONAL_STALK_BUILD_ONLY_V01.cst")
    ...
    summary={
      "mode":"R1E1A4A_H3A_ORTHOGONAL_STALK_ASSEMBLY_BUILD_ONLY",
      "simulationops":"0.2.5",
      "solver_run":False,
    ...
    final="PASS_R1E1A4A_H3A_ORTHOGONAL_STALK_BUILD_ONLY" if checks["pass"] else "HOLD_R1E1A4A_H3A_BUILD_QUALIFICATION"
