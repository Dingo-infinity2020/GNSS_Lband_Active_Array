"""R0.1A3 12-SLOT BUILD-ONLY harness (H01).
...
Session A: execute the repository-controlled macro body from
  source/cst/R0_CHARTS_12SLOT_BUILD_ONLY_V03.mcr in a fresh MWS, save, close.
Session B: fresh open; view-controlled screenshots + inventory/shape enumeration.
...
exposing the 200 mm ground gap, "Perspective" the oblique view.
"""
...
EV = os.path.join(REPO, "evidence", "r0_1a3_h01_20260922_2158")
WORK = r"D:\GNSS_Lband_Active_Array\_r0_1a3_h01_work"
CSTFILE = os.path.join(WORK, "R0_1A3_12SLOT_BUILD_ONLY_H01.cst")
MACRO = os.path.join(REPO, "source", "cst", "R0_CHARTS_12SLOT_BUILD_ONLY_V03.mcr")
...
EXPECT_ABSENT = [
    ("SlotTools", "CUT_OUTER_N_L"),
    ("SlotTools", "CUT_OUTER_N_R"),
    ("SlotTools", "CUT_OUTER_S_L"),
    ("SlotTools", "CUT_OUTER_S_R"),
    ("SlotTools", "CUT_OUTER_W_D"),
    ("SlotTools", "CUT_OUTER_W_U"),
    ("SlotTools", "CUT_OUTER_E_D"),
    ("SlotTools", "CUT_OUTER_E_U"),
...
def inventory_vba(outfile):
    lines = [
        ...
        'Print #fnum, "R0_1A3_OBJECT_INVENTORY"',
    ]
...
def build_session():
    ...
    try:
        ...
        err = try_vba(prj, "R0.1A3 12-slot build-only", body)
